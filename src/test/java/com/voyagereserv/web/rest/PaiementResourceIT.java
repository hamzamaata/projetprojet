...
import static com.voyagereserv.web.rest.TestUtil.sameInstant;
...
class PaiementResourceIT {
    ...
    public static Paiement createEntity(EntityManager em) {
        Paiement paiement = new Paiement().montant(DEFAULT_MONTANT).datePaiement(DEFAULT_DATE_PAIEMENT);
        return paiement;
    }
    ...
    public static Paiement createUpdatedEntity(EntityManager em) {
        Paiement paiement = new Paiement().montant(UPDATED_MONTANT).datePaiement(UPDATED_DATE_PAIEMENT);
        return paiement;
    }
    ...
    void putExistingPaiement() throws Exception {
        ...
        updatedPaiement.montant(UPDATED_MONTANT).datePaiement(UPDATED_DATE_PAIEMENT);
    ...
    void fullUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.montant(UPDATED_MONTANT).datePaiement(UPDATED_DATE_PAIEMENT);
