...
class ReservationResourceIT {
    ...
    private static final ServiceType DEFAULT_TYPE_SERVICE = ServiceType.VOL;
    private static final ServiceType UPDATED_TYPE_SERVICE = ServiceType.HOTEL;
    ...
    void createReservation() throws Exception {
        ...
        assertThat(testReservation.getTypeService()).isEqualTo(DEFAULT_TYPE_SERVICE);
    }
    ...
    void getAllReservations() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeService").value(hasItem(DEFAULT_TYPE_SERVICE.toString())));
    }
    ...
    void getReservation() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.typeService").value(DEFAULT_TYPE_SERVICE.toString()));
    }
    ...
    void putExistingReservation() throws Exception {
        ...
        updatedReservation.dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN).typeService(UPDATED_TYPE_SERVICE);
        ...
        assertThat(testReservation.getTypeService()).isEqualTo(UPDATED_TYPE_SERVICE);
    }
    ...
    void fullUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN).typeService(UPDATED_TYPE_SERVICE);
