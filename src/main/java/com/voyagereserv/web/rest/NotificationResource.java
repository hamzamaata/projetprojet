...
/**
 * REST controller for managing {@link com.voyagereserv.domain.Notification}.
 */
@RestController
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                ...
                if (notification.getContenu() != null) {
                    existingNotification.setContenu(notification.getContenu());
                }
                if (notification.getDestinataire() != null) {
                    existingNotification.setDestinataire(notification.getDestinataire());
                }
